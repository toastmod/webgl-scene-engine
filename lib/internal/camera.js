class Camera {
  ...
  fovy = (90.0 * Math.PI) / 180.0; // Vertical field of view in radians
  ...
  rotateY(xDeg, rad) {
    ...
    this.position[0] = rad * Math.cos((Math.PI * xDeg )/ 180.0);
    this.position[2] = rad * Math.sin((Math.PI * xDeg )/ 180.0);
  }
